...
public abstract class GUI {
	...
	protected abstract void lookForArticulation();
	 ...
	 */
	protected abstract void onLoad(File nodesFile, File roadsFile, File segmentsFile,
			File polygonsFile);
	...
	private void initialise() {
		...
		JToggleButton articulation = new JToggleButton("Find Articulation Points", false);
		...
		JToggleButton directions = new JToggleButton("Find a Path", false);
		...
		navigation.setMaximumSize(new Dimension(150, 100));
